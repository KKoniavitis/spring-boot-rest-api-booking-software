...
import com.kkoniavitis.wellness_beauty_appointments_app.shared.models.ExceptionResponse;
...
public class RestControllerExceptionHandler {
	...
	public ResponseEntity<ApiError> resolveException(BlogapiException exception) {
		String message = exception.getMessage();
		HttpStatus status = exception.getStatus();

		ApiError apiError = new ApiError();

		apiError.setSuccess(Boolean.FALSE);
	...
	public ResponseEntity<ApiError> resolveException(UnauthorizedException exception) {

		ApiError apiError = exception.getApiResponse();
	...
	@ResponseBody
	public ResponseEntity<ApiError> resolveException(BadRequestException exception) {
		ApiError apiError = exception.getApiResponse();
	...
	@ResponseBody
	public ResponseEntity<ApiError> resolveException(ResourceNotFoundException exception) {
		ApiError apiError = exception.getApiResponse();
	...
	@ResponseBody
	public ResponseEntity<ApiError> resolveException(AccessDeniedException exception) {
		ApiError apiError = exception.getApiResponse();
